...
## How to use
Python QueryGen is for creating queries, so you should have already manipulated the .CSV/.XLSX to the desired data for input. You can keep old column values if you require additional criteria when making an UPDATE or DELETE query.
...
Additionally, if it is an UPDATE query, you will be able to set the values of your chosen columns which are selected to be used in your query. Also, you will be able to choose additional columns in a second location. These columns are included in the WHERE clause of your query.
